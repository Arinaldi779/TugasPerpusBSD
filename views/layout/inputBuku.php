<div class="container mx-auto p-8 bg-gradient-to-r bg-primary rounded-xl shadow-2xl my-10 max-w-4xl">
    ...
    <form action="../logic/inputBukuLogic.php" method="post" enctype="multipart/form-data" class="space-y-6">
        <!-- Grid Layout -->
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div class="form-control w-full max-w-xs">
                ...
                <input type="text" id="datepicker" placeholder="Pilih tanggal"
                    class="input input-bordered w-full max-w-xs" name="tahun_terbit" />
            </div>
